...
| Phase 16: native E2E framework learning spike | planned | `docs/refactoring_subplans/phase_16_native_e2e_framework_learning_spike.md` | 2026-08-26 | Compare Patrol and Maestro on the same real Android document-picker cancellation flow; select a native E2E lane by measured setup, stability, CI, selector, privacy, and maintenance evidence. |
