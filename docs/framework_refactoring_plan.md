...
| Phase 16: native E2E framework learning spike | in progress | `docs/refactoring_subplans/phase_16_native_e2e_framework_learning_spike.md` | 2026-08-27 | Patrol Pilot A has started on the verified local API 36 emulator; Maestro remains planned and UI Automator/Appium are deferred. |
...
| Phase 16c: Maestro document-picker pilot | planned | `docs/refactoring_subplans/phase_16c_maestro_document_picker_pilot.md` | 2026-08-26 | Equivalent black-box Android picker-cancel flow, run twice, with comparable evidence. |
