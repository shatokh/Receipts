...
| Phase 16: native E2E framework learning spike | planned | `docs/refactoring_subplans/phase_16_native_e2e_framework_learning_spike.md` | 2026-08-26 | Compare Patrol and Maestro on the same real document-picker cancellation flow, then validate the stronger candidate with privacy-reviewed real-format receipt fixtures. UI Automator and Appium are documented but deferred. |
...
| Phase 16b: Patrol document-picker pilot | planned | `docs/refactoring_subplans/phase_16b_patrol_document_picker_pilot.md` | 2026-08-26 | One Android native picker-cancel flow, run twice, with setup and privacy evidence. |
