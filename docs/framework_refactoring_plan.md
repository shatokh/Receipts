...
| Phase 10: E2E UI automation strategy | complete | `docs/refactoring_subplans/phase_10_e2e_ui_automation_strategy.md` | 2026-08-26 | Widget state coverage and six deterministic Android `integration_test` journeys are complete; Patrol remains an optional native-surface spike. |
| Phase 15: Android device E2E automation track | in progress | `docs/refactoring_subplans/phase_15_android_device_e2e_track.md` | 2026-08-26 | Flutter E2E foundation checkpoint complete: six flows split, stable keys formalized, and local Android API 36 emulator run passes 6/6 in 1:49. Connected-device evidence and the separately scoped Patrol/Maestro learning spike remain. |
| Phase 16: native E2E framework learning spike | in progress | `docs/refactoring_subplans/phase_16_native_e2e_framework_learning_spike.md` | 2026-08-27 | Patrol and Maestro Pilot A both pass on the verified local API 36 emulator; framework decision and privacy-approved Pilot C remain. |
...
| Phase 16e: dual-framework redacted PDF pilots | blocked | `docs/refactoring_subplans/phase_16e_dual_framework_redacted_pdf_pilots.md` | 2026-08-28 | Maestro passed successful native import and exact duplicate twice with the approved synthetic fixture. Patrol opens and selects the same file, but `file_picker`'s result never reaches Dart under its JUnit runner; do not add an app test hook without a separate decision. |
