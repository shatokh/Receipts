...
| Phase 16a: E2E receipt fixture corpus | planned | `docs/refactoring_subplans/phase_16a_e2e_receipt_fixture_corpus.md` | 2026-08-26 | Prepare a short and long privacy-reviewed real-format PDF fixture from different month buckets, with an opaque manifest and no sensitive assertions. |
...
| Phase 16d: selected framework real-format receipt pilot | planned | `docs/refactoring_subplans/phase_16d_selected_framework_real_receipt_pilot.md` | 2026-08-26 | After decision and fixture approval, validate real-picker import plus month isolation or duplicate behavior. |
