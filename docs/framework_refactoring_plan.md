...
| Phase 15: Android device E2E automation track | in progress | `docs/refactoring_subplans/phase_15_android_device_e2e_track.md` | 2026-08-29 | Flutter E2E foundation checkpoint complete; the manual workflow remains outside PR/coverage gates. Phase 16 selected Maestro and Phases 17--18 supplied native-picker, navigation, and month-isolation evidence. Connected-device evidence remains a separately scoped follow-up. |
| Phase 15: E2E track reconciliation | complete | `docs/refactoring_subplans/phase_15_e2e_track_reconciliation.md` | 2026-08-29 | Active Android E2E documentation synchronized: Maestro is selected, Patrol is unsupported outside diagnosis, and the Flutter integration workflow remains distinct from the manual Maestro lane. |
...
| Phase 19: Maestro open receipt source smoke | planned | `docs/refactoring_subplans/phase_19_maestro_open_receipt_source.md` | 2026-08-29 | Reuse `receipt_a` to prove external PDF handler launch through one safe Back-to-Receipt-Details assertion. The verified AVD has a compatible handler; implementation has not started. |
